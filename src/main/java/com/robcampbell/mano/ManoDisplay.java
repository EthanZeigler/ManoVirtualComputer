...
public class ManoDisplay extends Panel {
    ...
    private Dimension MEDIUMAREA = new Dimension(150, 110);
    ...
    private void build() {
        ...
        lbSymbolTable.setLocation(430, 0);
        add(lbSymbolTable);

        lbSTHeader.setSize(XXMEDIUMLABEL);
        lbSTHeader.setLocation(430, 20);
        lbSTHeader.setFont(MONOFONT);
        add(lbSTHeader);

        lSymbolTable.setSize(MEDIUMAREA);
        lSymbolTable.setLocation(430, 40);
